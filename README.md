# Simulacrum
A personal AI assistant running on Raspberry Pi. Manages Google Calendar, transcribes voice notes, and remembers context via a secure Telegram interface. Powered by OpenAI models.
